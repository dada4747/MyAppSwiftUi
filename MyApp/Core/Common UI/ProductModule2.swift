...
//        ProductCoordinator(parent: self)
//    }
//    
...
//    private init() {}
//    
//    func makeProductUseCase(baseURL: String, env: AppEnvironmentType) -> ProductUseCase {
//        let service: ProductServiceProtocol
//        switch env {
//        case .mock: service = MockProductService()
//        case .live: service = LiveProductService(baseURL: baseURL)
//        }
